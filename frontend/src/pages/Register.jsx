      ...
      <div className="w-full h-screen flex justify-center items-center">
         <div className="card card-dash bg-base-100 p-1 w-96">
            <div className="card-body ">
               <h2 className="card-title mx-auto text-3xl leading-3">Are You Ready </h2>
               <p className="text-center text-gray-200/40 mb-4">Sign up here</p>
               {/* form elements*/}
               ...
               <div className="text-center text-xs">Have an account? <Link to="/login" className="text-primary">Login</Link></div>
            </div>
         </div>
      </div>
